...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>Biolife - Organic Drink</title>
        ...
        <nav class="navbar  navbar-inverse" style="background-color: blue;">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <a class="navbar-brand" style="float: right;" href="Home">Back</a>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
        <div id="main-content" class="main-content">
            <div class="container">
                ...
                <div class="row" >
                    ...
                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModalAddNew">Add New Product</button>
                    <!-- Modal -->
                            ...
                            <div class="modal-content">
                                ...
                                <form action="AddNewProduct" method="post">
                                    <div class="modal-body">
                                        ...
                                        <b>Price: </b><input type="text" class="form-control" value="" name="price"><br>
                                        <b>Category: </b>
                                        ...
                                        <b>Stock: </b><input type="text" class="form-control" value="" name="stock"><br>
                                        <b>Description: </b><input type="text" class="form-control" value="" name="descri"><br>
                                        <b>Image link:</b><input type="text" class="form-control" value="" name="img"><br>
                                    </div>
                        ...
                        <tbody>
                            <c:forEach var="p" items="${pl}">
                                <tr>
                                    ...
                                    <td><a href="DeleteProduct?pid=${p.getId()}" style="color: red;"> Delete</a></td>
                                    <td> <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal${p.getId()}">Edit</button></td>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="EditProduct" method="post">
                                            <div class="modal-body">
                                                ...
                                                <b>Price: </b><input type="text" class="form-control" value="${p.getPrice()}" name="price"><br>
                                                <b>Category: </b>
                                                <div style="height: 50px; w30pxidth: 100%">
                                                    <select  class="form-control" style="display: block;" name="category" >
                                                        <c:forEach var="c" items="${clist}">
                                                ...
                                                <b>Stock: </b><input type="text" class="form-control" value="${p.getStock()}" name="stock"><br>
